<div class="container">            
    <div id="application_form_layout" >
        <form name="application_form" id="application_form" class="needs-validation" novalidate method="POST" action="#">
            ...
            <div class="row"  >
                <div class="col-sm-4">
                    <label for="cert_type" class="control-label">Case type (*):</label>
                </div>
                <div class="col-sm-4">
            ...
            <div class="row" >
                <div class="col-sm-4">
                    <label for="cert_type" class="control-label">Certificate type  (*):</label>
                </div>
                <div class="col-sm-4">
                    <select class="custom-select small_font" name="cert_type" id="cert_type" onchange="changeType(this.value)" required>
    ...
    function getCertificateTypes(){
        ...
        if(resp.status === true){
            ...
            for(var i=0; i<cert_list.length; i++){
                layout += "<option value='"+cert_list[i].certificate_types_id+"'>"+cert_list[i].copy_name+"</option>";
            }
            $("#cert_type").html(layout);
        }
        else{
            alert(resp.msg);
        }
